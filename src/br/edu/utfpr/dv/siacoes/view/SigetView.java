...
public class SigetView extends CustomComponent implements View {

	public static final String NAME = "siget";
    ...
    public SigetView(){
    	this.setCaption(SystemModule.SIGET.getDescription());
    	this.menu = new MenuBar(SystemModule.SIGET);
    	
    	this.label = new Label("Sistema de Gestão de TCC's");
